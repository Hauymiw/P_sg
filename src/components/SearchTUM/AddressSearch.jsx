...
import addressData from '../../app/data/provinces.json';
import "./TUM.css"; // สร้างไฟล์ CSS แยกถ้าต้องการ
        ...
        <div className="area_bk_pupup">
            ...
            <div className="area_bnt">
                <div className='bnt_sh'>
                    <button className="bnt_ok" onClick={onClose}>OK</button>
                    <button className="bnt_cel" onClick={onClose}>Cancel</button>
